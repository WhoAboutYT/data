...
repeat
	task.wait()
until _G.WindUI and _G.Functions and _G.Connections and _G.Connections.OnLocalPlayerViewed
...
local PlayerViewedEventFn = function(playerInfo)
	if not playerInfo or typeof(playerInfo) ~= "table" then
		return
	end
	...
	if _G.Invisibility or _G.AutoArrest then
		...
		_G.Window.TabModule.Tabs[1].Elements[8].Callback(false) -- Auto Arrest
		_G.Window.TabModule.Tabs[2].Elements[1].Callback(false)  -- WalkSpeed Modifiers
